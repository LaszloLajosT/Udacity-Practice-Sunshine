...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String preferredUnits  = prefs.getString(keyForUnit, defaultUnits);
        String metrix = context.getString(R.string.pref_units_metric);
        boolean userPrefersMetric;

        userPrefersMetric = metrix.equals(preferredUnits);
